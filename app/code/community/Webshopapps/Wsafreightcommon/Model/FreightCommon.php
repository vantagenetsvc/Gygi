...
class Webshopapps_Wsafreightcommon_Model_FreightCommon extends Mage_Core_Model_Abstract {
    ...
    public function getCode($type, $code='')
    {
        ...
        $codes = array(
            'display_rules' => array(
                'product_ships_freight'     => Mage::helper('wsafreightcommon')->__('Product ships Freight'),
            ...
            'ship_rules' => array(
                'product_freight'           => Mage::helper('wsafreightcommon')->__('Product ships Freight'),
                'product_freight_and_must'  => Mage::helper('wsafreightcommon')->__('Product ships Freight & Must Ship Freight set'),
