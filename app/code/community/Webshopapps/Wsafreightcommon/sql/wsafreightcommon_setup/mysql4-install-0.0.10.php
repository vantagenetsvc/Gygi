...
if  (Mage::helper('wsalogger')->getNewVersion() > 10 ) {
	...
	ALTER IGNORE TABLE {$this->getTable('sales_flat_quote_address')} ADD shipto_type tinyint(1);
	...
	ALTER IGNORE TABLE {$this->getTable('sales_flat_order')} ADD shipto_type tinyint(1);
