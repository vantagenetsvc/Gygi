    ...
    public function getFlatBoxAllowedMethods($boxCode){
        ...
        foreach ($boxCode as $code) {
            switch ($code) {
                ...
                case 99:
                    if($isUS) {
                        $allowedMethods[] = 'Priority Mail Small Flat Rate Box';
                        $allowedMethods[] = 'Priority Mail Medium Flat Rate Box';
                        $allowedMethods[] = 'Priority Mail Large Flat Rate Box';
                    } else {
                        $allowedMethods[] = 'Priority Mail International Small Flat Rate Box';
                        $allowedMethods[] = 'Priority Mail International Medium Flat Rate Box';
                        $allowedMethods[] = 'Priority Mail International Large Flat Rate Box';
                    }
                    break;
            }
        }
