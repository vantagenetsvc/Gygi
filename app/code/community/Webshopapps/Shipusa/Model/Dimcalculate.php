...
class Webshopapps_Shipusa_Model_Dimcalculate
{
    ...
    private function getDefaultBox() {
        ...
        $boxes[$key]['box_volume'] 	        = $this->_calculateBoxVolume($boxes[$key]['length'],$boxes[$key]['height'],$boxes[$key]['width']);
    ...
    protected function _calculateBoxVolume($length,$height,$width) {
 	...
 	public function getSingleBoxes($sku)
    {
        ...
        foreach ($boxes as $key=>$box) {
            ...
            $boxes[$key]['box_volume'] 	        = $this->_calculateBoxVolume($boxes[$key]['length'],
