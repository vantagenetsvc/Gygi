...
class MagenThemes_FilterPrice_productController extends Mage_Core_Controller_Front_Action {
	public function compareAction(){
		...
		if ($productId = (int) $this->getRequest()->getParam('product')) {
			...
			if ($product->getId()/* && !$product->isSuper()*/) {
				...
				$sidebar_block->setTemplate('magenthemes/filterprice/compare/sidebar.phtml');
				...
				if (!$productId) {
					...
					if (!$product->getId() || !$product->isVisibleInCatalog()) {
						...
						try {
							...
							if($sidebar_block){
								$sidebar_block->setTemplate('magenthemes/filterprice/wishlist/sidebar.phtml');
								$sidebar = $sidebar_block->toHtml();
