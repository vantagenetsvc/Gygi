<?php
class MagenThemes_FilterPrice_Block_Filter_Slider extends Mage_Catalog_Block_Product_Abstract
{
 /**
     ...
     * @var string
     */
    protected $_defaultToolbarBlock = 'filterprice/filter_tool';
