...
class MagenThemes_FilterPrice_Block_Filter_Tool extends Mage_Core_Block_Template
{
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('magenthemes/filterprice/filter_toolbar.phtml');
    }
    ...
    {	 
        $pagerBlock = $this->getLayout()->createBlock('filterprice/filter_pager');
